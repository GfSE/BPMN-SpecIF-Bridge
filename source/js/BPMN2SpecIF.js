...
function BPMN2Specif( fileName, xmlString, svgFile ) {
...
function jsonBuilder( elements, svgFile ) {
	var d = new Date();
	...
	model.title = prompt("Bitte geben Sie einen Projektnamen ein", "DefaultTitle");
	model.description = prompt("Bitte geben Sie eine Projektbeschreibung ein", "DefaultDescription");
	...
	zipCreator(myJSON, svgFile, model.title)
}

// Herunterladen der .specifz Datei
